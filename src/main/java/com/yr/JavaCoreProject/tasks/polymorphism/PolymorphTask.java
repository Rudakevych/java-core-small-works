...
public class PolymorphTask {
    ...
    public ArrayList<Product> getAProductByCategory(User user, String productCatogoryName) {
        ArrayList<Product> listOfProductsWithNeededCategory = new ArrayList();
    ...
    public ArrayList<Order> numberOfTheMoustBiggerCoastOrder(User user, int numberOfOrders) {
        ArrayList<Order> listOfOrdersWithBiggestPrice = user.getOrders();
        ArrayList<Order> oneMoreOrdersList = new ArrayList<>();

//        for (int i = 0; i < listOfOrdersWithBiggestPrice.size(); i++) {
//            for (int j = 1; j < listOfOrdersWithBiggestPrice.size(); j++) {
...
////                });
//
////                oneMoreOrdersList.add(user.getOrders().get(i).equals(user.getOrders().get(j)))
//            }
//        }
