...
public class TaskSIngelton {
    private static TaskSIngelton taskSIngelton = null;

    private TaskSIngelton() {
    }

    public static TaskSIngelton getTaskSIngelton(){
        if(taskSIngelton == null){
            taskSIngelton = new TaskSIngelton();
        }
        return taskSIngelton;
    }

    public final Map<String, Character> QUESTIONS = new HashMap<String, Character>() {
        {
